...
class YOLOv8:
    ...
    def __init__(self, onnx_model, confidence_thres, iou_thres):
        ...
        try:
            ...
            names = ast.literal_eval(model_metadata.custom_metadata_map['names'])
            self.classes = names
        except Exception as exp:
            print("onnx MetaData get error! using default names")
    ...
    def postprocess(self, input_image, output):
        ...
        return input_image, pred_class_ids
    ...
    def process_one_image(self, input_path):
        ...
        return self.postprocess(self.img, outputs)  # output image, pred_ids


if __name__ == "__main__":
    # Create an argument parser to handle command-line arguments
    default_onnx = "../../yolo_models/hsh_18_model.onnx"
    default_img = "./data/test1-0_20240514-152234-0__1.jpg"
    parser = argparse.ArgumentParser()
    parser.add_argument("--model", type=str, default=default_onnx, help="Input your ONNX model.")
    ...
    output_image, pred_ids = detection.process_one_image(args.img)
